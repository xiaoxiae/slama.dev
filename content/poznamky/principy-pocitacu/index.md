...
pdf: true
description: Poznámky z přednášky Principy Počítačů (Pavel Ježek, 2019/2020).
toc: true
language: cs
---
...
- dohoda, jak přenos vypadá... \[ \underbrace{\text{den}}_{9b}/\underbrace{\text{měsíc}}_{5b}/\underbrace{\text{rok}}_{7b} = \underbrace{101101010/11010/0010001}_{\text{pa(c)ket}} \]
