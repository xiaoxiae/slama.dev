...
Top_Style = "silksong2"; // [base_sm:Plain - Single Material, base_mm2:Plain - Two Materials, logo_sm:Logo - Single Material, logo_mm2:Logo - Two Materials, logo_mm3:Logo - Three Materials, hex_sm:Hexagons - Single Material, hex_mm2:Hexagons - Two Materials, slots_sm:Slots - Single Material, mesh_sm:Mesh - Single Material, pihole_sm:Pi-hole Logo - Single Material, pihole_mm4:Pi-hole Logo - Four Materials, silksong1:Silksong 1 - Single Material, silksong1_mm2:Silksong 1 - Two Materials, silksong2:Silksong 2 - Single Material, silksong2_mm2:Silksong 2 - Two Materials]
...
SVG2_Rotate = 180;
// hk-2.svg content center X in SVG units — adjust until design is centered in F5 preview
SVG2_Center_X = 90.4;
// hk-2.svg content center Y in SVG units — adjust until design is centered in F5 preview
SVG2_Center_Y = 86.4;
