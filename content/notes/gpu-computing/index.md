...
1. Introduction [[slides](slides/01.pdf)]
2. CUDA programming [[slides](slides/02.pdf)]
3. Basic architecture [[slides](slides/03.pdf)]
4. Matrix multiplication optimizations [[slides](slides/04.pdf)]
5. Parallel computing [[slides](slides/05.pdf)]
6. Profiling [[slides](slides/06.pdf)]
7. Scheduling optimizations [[slides](slides/07.pdf)]
8. \(n\)-body optimization [[slides](slides/08.pdf)]
9. Host-device optimizations [[slides](slides/09.pdf)]
10. OpenACC [[slides](slides/10.pdf)]
11. Stencil computations [[slides](slides/11.pdf)]
12. OpenCL [[slides](slides/12.pdf)]
13. Consistency & Coherence [[slides](slides/13.pdf)]
...
![Thread and memory diagram for CUDA.](grid-block-thread.png)
{.no-invert}
...
![Offset and stride access graph.](offset-stride-access.png)
{.no-invert}
...
![Stride access for Shared memory graph.](stride-shared-access.png)
{.no-invert}
...
{{< math "definition" "synchronization" >}}enforcement of a defined logical order between events. This establishes a defined time-relation between distinct places, thus defining their behavior in time.{{< /math >}}
...
![Reduction: naive implementation diagram.](reduction-naive.png)
{.no-invert}
...
![Reduction: interleaved address divergent diagram.](reduction-addresses.png)
{.no-invert}
...
![Reduction: resolving bank conflicts diagram.](reduction-bank.png)
{.no-invert}
...
![SAXPY without streaming.](saxpy-nostream.png)
{.no-invert}
...
![SAXPY with streaming.](saxpy-stream.png)
{.no-invert}
...
![Improved SAXPY streams diagram.](stream-issues.webp)
{.no-invert}
