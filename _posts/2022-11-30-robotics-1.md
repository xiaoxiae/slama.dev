...
This will yield the entire homogeneous matrix -- if we only want position, we can only focus on the last row, i.e. \[p^0_3 (\mathbf{q}) = A^0_1 A^1_2 A^2_3 \cdot (0, 0, 0, 1)^T\]
