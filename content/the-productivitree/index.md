---
date: '2021-10-04'
title: The Productivitree
description: A fun experiment on productivity using a (productivi)tree.
---
...
The above image was generated using **weighted stippling**, which is a technique where a given image is converted into a set of points of varying thickness (see [this paper](npar2002_ajsecord_preprint.pdf) if you're interested in the math behind it).
...
As for updating the image after being productive, I created a simple script that does this automatically, selecting the dot that is closest to the center.
