module Jekyll
  module Tags
    class LectureNotesPreface < Liquid::Tag
      ...
      def render(context)
        if @parts.length == 3
          return "<h3>Preface</h3><p>This website contains my lecture notes from a lecture by #{@parts[0]} lecture from the academic year #{@parts[1]}. If you find something incorrect/unclear, or would like to contribute either text or an image, feel free to submit a <a href='https://github.com/xiaoxiae/slama.dev/blob/master/_posts/'>pull request</a> (or let me know via email).</p>"
        else
