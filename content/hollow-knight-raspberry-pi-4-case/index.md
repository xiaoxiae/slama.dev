...
I found **[this awesome modular one by Malolo](https://www.thingiverse.com/thing:3723561)**, which contained OpenSCAD source files, making it extremely easy to modify the source files to cut an SVG of my choice.
...
I came up with two designs: one for **Hollow Knight** ([shade](https://hollowknight.fandom.com/wiki/Shade?file=Char_shade.png)), and the other for **Hollow Knight: Silksong** ([Faydown Cloak](https://hollowknightsilksong.wiki.fextralife.com/Faydown+Cloak)), both etched into the top as seen in the images below:
