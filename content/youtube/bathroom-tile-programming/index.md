...
![Minimal parentheses tiling](parentheses_minimal.webp)
{.inverse-invert}
...
![Power of two tiling](power_of_two.webp)
{.inverse-invert}
...
{{< details "**Task:** accept the input \(\iff\) it is divisible by 13 (given in base 10)" >}}
...
![Divisible by 13 tiling](divisible.webp)
{.inverse-invert}
