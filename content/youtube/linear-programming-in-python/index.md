...
{{< details "Output" "farmer.out" >}}{{< /details >}}
...
{{< details "Source code" "knapsack.py" >}}{{< /details >}}

{{< details "Output" "knapsack.out" >}}{{< /details >}}
...
{{< details "Source code" "vertex-coloring.py" >}}{{< /details >}}
...
{{< details "Output" "tsp.out" >}}{{< /details >}}
...
{{< details "Source code" "bin.py" >}}{{< /details >}}

{{< details "Output" "bin.out" >}}{{< /details >}}
...
{{< details "Source code" "partition.py" >}}{{< /details >}}

{{< details "Output" "partition.out" >}}{{< /details >}}
...
{{< details "Source code" "max-independent-set.py" >}}{{< /details >}}

{{< details "Output" "max-independent-set.out" >}}{{< /details >}}
...
{{< details "Source code" "min-vertex-cover.py" >}}{{< /details >}}

{{< details "Output" "min-vertex-cover.out" >}}{{< /details >}}
