...
date: '2024-01-19'
title: Chiptunes
description: An experiment in making chiptune music.
categoryIcon: /assets/category-icons/music.svg
---
...
<ol>
  <li value="99"><strong>day:</strong> finishing touches on the (start of the) Waltz</li>
    <ul>
      <li><strong>here are the results</strong> (still pretty bad): <a href="Second.wav">Second.wav</a> (20 seconds), <a href="Second.fur">Second.fur</a> (Furnace file)</li>
    </ul>
</ol>
