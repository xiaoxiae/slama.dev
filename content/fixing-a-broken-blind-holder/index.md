...
{{< photo_section caption="The working/broken holders (top left), and the working one in action (top right)." >}}
{{< photo_row "working-and-broken.png :: A working holder, and the broken one. | working-in-action.png :: The working holder in action." >}}
{{< /photo_section >}}

{{< photo_section caption="The dense pointcloud (left) and its corresponding 3D mesh (right), created from 76 images via <a href=\"https://colmap.github.io/\">colmap</a> (top)." >}}
{{< photo_row "mosaic.png :: A working holder, and the broken one." >}}
{{< photo_row "pointcloud.png :: A working holder, and the broken one. | mesh.png :: The working holder in action." >}}
{{< /photo_section >}}
...
{{< photo_section caption="The first print attempt with PLA (left), and the second with TPU (right)." >}}
{{< photo_row "3d-print-pla.png :: A working holder, and the broken one. | 3d-print-tpu.png :: The working holder in action." >}}
{{< /photo_section >}}
