...
{{< statnice "obecna_matematika" >}}

#### Informatika

{{< statnice "obecna_informatika" >}}
...
### Poděkování
- **shrekofspeed** (Discord) za upozornění na [požadavky](https://www.mff.cuni.cz/cs/studenti/bakalarske-studium/statni-zaverecne-zkousky/bakalarske-statni-zkousky-studijniho-programu-informatika/detailni-pozadavky.pdf) a na Medvědovo [Grafové Algoritmy](ga.pdf)
