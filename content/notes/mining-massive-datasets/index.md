...
5. Page Rank 1 [[slides](05.pdf)]
6. Page Rank 2 [[slides](06.pdf)]
7. Locality Sensitive Hashing 1 [[slides](07.pdf)]
...
{{< math "definition" "Transformer" >}}an algorithm which transforms one DataFrame into another{{< /math >}}
...
![PySpark ML pipeline illustration.](sparkml.webp)
...
#### Preface
{{< math "definition" "hash function" >}}function \(h: D \mapsto R\), where \(D\) is a large domain space and \(R\) a small range space (usually integers).{{< /math >}}
...
![Locality-Sensitive Hashing example.](lsh.svg)
...
![A-Priori memory layout illustration.](ap.svg)
